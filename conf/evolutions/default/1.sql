...
create table index_slider (
  ...
  constraint pk_index_slider primary key (id)
);
create sequence index_slider_seq;
...
create table product_warehouse (
  ...
  constraint pk_product_warehouse primary key (id)
);
...
alter table product_warehouse add constraint fk_product_warehouse_warehouse_email foreign key (warehouse_email) references user (email) on delete restrict on update restrict;
create index ix_product_warehouse_warehouse_email on product_warehouse (warehouse_email);
...
alter table shop_order add constraint fk_shop_order_warehouse_email foreign key (warehouse_email) references user (email) on delete restrict on update restrict;
create index ix_shop_order_warehouse_email on shop_order (warehouse_email);
...
drop index if exists ix_product_warehouse_product_id;

alter table product_warehouse drop constraint if exists fk_product_warehouse_warehouse_email;
drop index if exists ix_product_warehouse_warehouse_email;
...
alter table shop_order drop constraint if exists fk_shop_order_warehouse_email;
drop index if exists ix_shop_order_warehouse_email;
...
drop sequence if exists index_slider_seq;
...
drop sequence if exists product_warehouse_seq;
